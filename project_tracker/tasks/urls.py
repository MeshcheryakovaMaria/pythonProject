...
urlpatterns = [
    ...
    path('quality_control/', views.ProjectsListView.as_view(), name='quality_control'),
...
# #Function-Based Views (FBV)
    ...
    # path('projects/<int:project_id>/task/<int:task_id>/update/', views.update_task, name='update_task'),
